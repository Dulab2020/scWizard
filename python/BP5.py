...
def get_BP5_res(X_total, Y_total, X_verify, subclusters, num_classes, input_size, hidden_units_size1, hidden_units_size2, hidden_units_size3, regularizer1, regularizer2, learn_rate):
